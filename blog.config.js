...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi,欢迎来到我们的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '爱赢交易工作室', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '职业交易工作室', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://itrading.win', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '外汇，黄金，返佣，返利，比特币，以太坊，XAUUSD', // 网站关键词 英文逗号隔开
  ...
  PREVIEW_CATEGORY_COUNT: 25, // 首页最多展示的分类数量，0为不限制
  PREVIEW_TAG_COUNT: 25, // 首页最多展示的标签数量，0为不限制
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '欢迎访问爱赢交易工作室网站！', // 站点描述，被notion中的页面描述覆盖
